...
const AgendaComponent = () => {
  ...
  const reservationsKeyExtractor = useCallback((item: DayAgenda, index: Number) => {
  ...
  return ( 
    <View style={styles.container}>
      <Agenda
        ...
        theme={{calendarBackground: '#d3d1d1',
         selectedDayBackgroundColor: '#373434', 
         agendaKnobColor: 'black', 
         selectedDotColor:'#343434',
         dotColor: '#424141', todayTextColor: '#000000', textDayFontWeight: 'bold', textMonthFontWeight: 'bold', textDayHeaderFontWeight: 'bold', textDayFontSize: 16, textMonthFontSize: 16, textDayHeaderFontSize: 16, dayTextColor: '#000000', monthTextColor: '#000000', textSectionTitleColor: '#000000', agendaDayTextColor: '#000000', agendaDayNumColor: '#000000', agendaTodayColor: '#000000'}}
